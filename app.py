...
<div class="table-responsive">
    <table class="table table-striped table-hover table-bordered text-center" id="facturasTable">
            ...
            <tr>
                ...
                <td>
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        {% if detalle.orden and detalle.orden.doctor %}
                        <li>{{ detalle.orden.doctor.nombre_completo() }}</li>
                        {% endif %}
                        {% endfor %}
                    </ul>
                    {% else %}
                ...
                <td>
                    {% if f.detalles and f.detalles[0].orden.doctor %}
                    {{ f.detalles[0].orden.doctor.clinica_particular or '-' }}
                    {% else %}
                    -
                    {% endif %}
                </td>
                ...
                <td>
                    {% if f.archivo_pdf %}
                        <a href="{{ f.archivo_pdf }}" target="_blank" class="btn btn-sm btn-info">
                            Descargar PDF
                        </a>
                    {% else %}
